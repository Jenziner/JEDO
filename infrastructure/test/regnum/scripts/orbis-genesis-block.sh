...
log_section "JEDO-Ecosystem - Orbis - Genesisblock configuring..."
...
LOCAL_CONFIG_DIR="${SCRIPTDIR}/../../configuration_orbis"
...
log_info "Genesis block for $ORBIS_NAME generating..."
FABRIC_LOGGING_SPEC=$FABRIC_LOGGING_SPEC
$LOCAL_FABRIC_DIR/configtxgen -configPath $FABRIC_CFG_PATH -profile JedoChannel -channelID $ORBIS_NAME -outputBlock $FABRIC_CFG_PATH/genesisblock

log_ok "Channel $ORBIS_NAME configured..."

# chmod -R 777 /mnt/user/appdata/jedo/demo/configuration_orbis
