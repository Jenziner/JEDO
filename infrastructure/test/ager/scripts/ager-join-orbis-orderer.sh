...
#!/bin/bash
#
# This script joins orderer nodes to orbis channel.
#
###############################################################
set -euo pipefail
...
log_section "JEDO-Ecosystem - Orderer joining ORBIS channel..."
...
log_info "$ORDERER_CN_NAME joins $ORBIS_NAME..."
...
log_ok "$ORDERER_CN_NAME joined $ORBIS_NAME."
