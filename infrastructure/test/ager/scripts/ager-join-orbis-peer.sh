...
#!/bin/bash
#
# This script joins peer nodes to ORBIS channel.
#
###############################################################
set -euo pipefail
...
log_section "JEDO-Ecosystem - Peer joining ORBIS channel..."
...
log_info "$PEER_CN_NAME joins $ORBIS_NAME..."
...
log_ok "$PEER_CN_NAME joined $ORBIS_NAME."
